...
/***/ "./js/modules/animation-at-scroll.js":
/*!*******************************************!*\
  !*** ./js/modules/animation-at-scroll.js ***!
  \*******************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export */ __webpack_require__.d(__webpack_exports__, {\n/* harmony export */   \"default\": () => (/* binding */ initAnimationOnScroll)\n/* harmony export */ });\nfunction initAnimationOnScroll() {\n  var sections = document.querySelectorAll(\"[data-anime='scroll']\");\n\n  function scrollAnimation() {\n    var windowHeightHalf = window.innerHeight * 0.6;\n    sections.forEach(function (section) {\n      var sectionTop = section.getBoundingClientRect().top;\n      var isSectionVisible = sectionTop - windowHeightHalf < 0;\n\n      if (isSectionVisible) {\n        section.classList.add(\"animate\");\n      } else if (section.classList.contains(\"animate\")) {\n        section.classList.remove(\"animate\");\n      }\n    });\n  }\n\n  if (sections.length) {\n    scrollAnimation();\n    window.addEventListener(\"scroll\", scrollAnimation);\n  }\n}\n\n//# sourceURL=webpack://animais-fantasticos/./js/modules/animation-at-scroll.js?");
...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export */ __webpack_require__.d(__webpack_exports__, {\n/* harmony export */   \"default\": () => (/* binding */ initOpeningHours)\n/* harmony export */ });\nfunction initOpeningHours() {\n  // Get datasets into arrays\n  var functioning = document.querySelector(\"[data-week]\");\n  var workHours = functioning.dataset.hours.split(\",\").map(Number);\n  var weekDays = functioning.dataset.week.split(\",\").map(Number); // Get current date and time\n\n  var dateNow = new Date();\n  var curWeekDay = dateNow.getDay();\n  var curHour = dateNow.getUTCHours() - 3; // Verify if current date matches the opening hours.\n\n  var weekOpen = weekDays.indexOf(curWeekDay) !== -1;\n  var openingHours = curHour >= workHours[0] && curHour < workHours[1];\n  if (weekOpen && openingHours) functioning.classList.add(\"open\");else functioning.classList.add(\"closed\");\n}\n\n//# sourceURL=webpack://animais-fantasticos/./js/modules/opening-hours.js?");
...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export */ __webpack_require__.d(__webpack_exports__, {\n/* harmony export */   \"default\": () => (/* binding */ TabNavMenu)\n/* harmony export */ });\n/* harmony import */ var _babel_runtime_helpers_classCallCheck__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @babel/runtime/helpers/classCallCheck */ \"./node_modules/@babel/runtime/helpers/esm/classCallCheck.js\");\n/* harmony import */ var _babel_runtime_helpers_createClass__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @babel/runtime/helpers/createClass */ \"./node_modules/@babel/runtime/helpers/esm/createClass.js\");\n\n\n\nvar TabNavMenu = /*#__PURE__*/function () {\n  function TabNavMenu(menu, content) {\n    (0,_babel_runtime_helpers_classCallCheck__WEBPACK_IMPORTED_MODULE_0__[\"default\"])(this, TabNavMenu);\n\n    this.tabMenu = document.querySelectorAll(menu);\n    this.tabContent = document.querySelectorAll(content);\n    this.activeClass = 'active';\n  }\n\n  (0,_babel_runtime_helpers_createClass__WEBPACK_IMPORTED_MODULE_1__[\"default\"])(TabNavMenu, [{\n    key: \"activeTab\",\n    value: function activeTab(i) {\n      var _this = this;\n\n      // i = index\n      this.tabContent.forEach(function (content) {\n        content.classList.remove(_this.activeClass, _this.tabContent[i].dataset.anime);\n      });\n      var animeClass = this.tabContent[i].dataset.anime;\n      this.tabContent[i].classList.add(this.activeClass, animeClass);\n    }\n  }, {\n    key: \"addEvent\",\n    value: function addEvent() {\n      var _this2 = this;\n\n      this.tabMenu.forEach(function (item, i) {\n        item.addEventListener('click', function () {\n          return _this2.activeTab(i);\n        });\n      });\n    }\n  }, {\n    key: \"init\",\n    value: function init() {\n      if (this.tabMenu.length && this.tabContent.length) {\n        this.activeTab(0);\n        this.addEvent();\n      }\n    }\n  }]);\n\n  return TabNavMenu;\n}();\n\n\n\n//# sourceURL=webpack://animais-fantasticos/./js/modules/tabNav.js?");
